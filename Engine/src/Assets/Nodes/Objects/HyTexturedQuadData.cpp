...
HyTexturedQuadData::HyTexturedQuadData(HyAuxiliaryFileHandle hFileHandle, std::string sFilePath, HyImageInfo imageInfo, HyTextureInfo textureInfo, HyAssets &assetsRef) :
	IHyNodeData(HyNodePath(0, hFileHandle)),
	m_pAtlas(HY_NEW HyFileAtlas(hFileHandle, sFilePath, imageInfo, textureInfo)),
...
const HyUvCoord &HyTexturedQuadData::GetUvCoords() const
{
	return m_UvCoords;
}
