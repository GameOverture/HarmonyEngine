...
HyText2dData::HyText2dData(const std::string &sPath, HyJsonObj &itemDataObjRef, HyAssets &assetsRef) :
	IHyNodeData(sPath),
	...
	m_uiNumStates(0)
{
	...
	HyJsonArray fontArray = itemDataObjRef["fontArray"].GetArray();
	...
	HyJsonArray stateArray = itemDataObjRef["stateArray"].GetArray();
