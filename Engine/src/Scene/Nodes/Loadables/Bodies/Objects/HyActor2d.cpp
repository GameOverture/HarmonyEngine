...
HyActor2d::HyActor2d(HyEntity2d *pParent /*= nullptr*/) :
	...
	m_PhysicsMover(this)
{
	m_PhysicsMover.SetPhysicsAllowed(false);
	m_PhysicsMover.SetAsCapsule(glm::vec2(0.0f, -0.5f), glm::vec2(0.0f, 0.5f), 0.3f);
}
...
/*virtual*/ void HyActor2d::Update() /*override*/
{
	...
	m_Locomotion.UpdatePhysical(IHyNode::sm_pScene->GetPhysicsWorld(), ptPos, bOnGround, m_PhysicsMover.GetAsCapsule(), pogoFilter, collideFilter, castFilter);
