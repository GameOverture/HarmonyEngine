	...
	IHyDrawable2d(HYTYPE_TexturedQuad, nodePath, pParent)
{
	...
	{
		HyTextureQuadHandle hTexQuadHandle = HyEngine::CreateTextureQuad(HyIO::CleanPath(nodePath.GetPath().c_str()), HyImageInfo(), HyTextureInfo());
...
HyTexturedQuad2d::HyTexturedQuad2d(std::string sFilePath, HyImageInfo imageInfo, HyTextureInfo textureInfo, HyEntity2d *pParent /*= nullptr*/) :
	IHyDrawable2d(HYTYPE_TexturedQuad, HyNodePath(), pParent)
{
	m_ShaderUniforms.SetNumTexUnits(1);
...
void HyTexturedQuad2d::Init(std::string sFilePath, HyImageInfo imageInfo, HyTextureInfo textureInfo, HyEntity2d *pParent)
{
	HyTextureQuadHandle hTexQuadHandle = HyEngine::CreateTextureQuad(HyIO::CleanPath(sFilePath.c_str()), imageInfo, textureInfo);
