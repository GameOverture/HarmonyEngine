...
public:
	...
	HyFileAtlas(HyAuxiliaryFileHandle hGivenHandle, std::string sFileName, HyImageInfo imageInfo, HyTextureInfo textureInfo);
	...
	bool GetUvRect(uint32 uiChecksum, HyUvCoord &UVRectOut, uint64 &cropMaskOut) const;
