...
public:
	...
	HyTexturedQuad2d(std::string sFilePath, HyImageInfo imageInfo, HyTextureInfo textureInfo, HyEntity2d *pParent = nullptr);
	...
	void Init(std::string sFilePath, HyImageInfo imageInfo, HyTextureInfo textureInfo, HyEntity2d *pParent);
	void Uninit();
