...
protected:
	...
	virtual void OnUpdateUniforms(float fExtrapolatePercent) { } // Invoked before AppendRenderState(), last chance to update ShaderUniforms for the frame. HyPrimitives need this or they glitch out upon new texture loads
