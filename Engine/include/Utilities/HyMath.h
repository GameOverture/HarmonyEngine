...
public:
	...
	static void ComputeAABB(b2AABB &aabbOut, const glm::vec2 *pPointList, int32 iPointCount, float fInflateFlatDimensions = 0.0f);
	...
	static glm::ivec2 TileMapPointToCell_Square(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);
	static glm::ivec2 TileMapPointToCell_HalfSquare(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);
	static glm::ivec2 TileMapPointToCell_Isometric(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);
	static glm::ivec2 TileMapPointToCell_IsometricStaggerX(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);
	static glm::ivec2 TileMapPointToCell_IsometricStaggerY(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);
	static glm::ivec2 TileMapPointToCell_HexagonFlatTop(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);
	static glm::ivec2 TileMapPointToCell_HexagonPointTop(const glm::vec2 &ptLocal, const glm::ivec2 &vCellDimensions);

	static glm::vec2 TileMapCellToPoint_Square(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
	static glm::vec2 TileMapCellToPoint_HalfSquare(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
	static glm::vec2 TileMapCellToPoint_Isometric(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
	static glm::vec2 TileMapCellToPoint_IsometricStaggerX(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
	static glm::vec2 TileMapCellToPoint_IsometricStaggerY(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
	static glm::vec2 TileMapCellToPoint_HexagonFlatTop(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
	static glm::vec2 TileMapCellToPoint_HexagonPointTop(const glm::ivec2 &ptCellCoord, const glm::ivec2 &vCellDimensions);
