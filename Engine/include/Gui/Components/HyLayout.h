...
class HyLayout : public IHyGuiBase
{
...
public:
	...
	void AppendItem(IHyGuiBase &itemRef);
	bool RemoveItem(IHyGuiBase &itemRef);
	void DetachAllItems();
...
private:
	...
	using IHyGuiBase::SetMinSize;			// Min Size is dictated by the margins and items within the layout
};
