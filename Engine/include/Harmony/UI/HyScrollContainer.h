...
public:
	HyScrollContainer(HyOrientation eRootLayoutDirection, const HyPanelInit &initRef, uint32 uiScrollBarDiameter, bool bUseVert, bool bUseHorz, HyEntity2d *pParent = nullptr);
