...
public:
	...
	virtual void SetAsStacked(HyAlignment eTextAlignment = HYALIGN_HCenter, bool bUseScaleBox = true);							// Default setup. Shows text positioned on top and inside the panel based on 'eTextAlignment' and 'bUseScaleBox'
