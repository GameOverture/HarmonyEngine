...
public:
	...
	void Tween(int32 iX, int32 iY, float fSeconds, HyTweenFunc fpTween = HyTween::Linear, HyAnimFinishedCallback fpFinishedCallback = HyAnimFloat::NullFinishedCallback);
	void Tween(float fX, float fY, float fSeconds, HyTweenFunc fpTween = HyTween::Linear, HyAnimFinishedCallback fpFinishedCallback = HyAnimFloat::NullFinishedCallback);
	void TweenOffset(float fOffsetX, float fOffsetY, float fSeconds, HyTweenFunc fpTween = HyTween::Linear, HyAnimFinishedCallback fpFinishedCallback = HyAnimFloat::NullFinishedCallback);
