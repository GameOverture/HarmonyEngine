...
class HyTexturedQuad2d : public IHyInstance2d
{
protected:
...
public:
	HyTexturedQuad2d(uint32 uiAtlasGrpId, uint32 uiIndexInGroup);
	HyTexturedQuad2d(HyTextureHandle hTextureHandle, uint32 uiTextureWidth, uint32 uiTextureHeight);
