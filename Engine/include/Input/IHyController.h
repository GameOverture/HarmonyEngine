...
protected:
	...
	int32				m_iRefCount;	// HyInputMap reference count. Zero means this controller is not in use by an input map
...
protected:
	...
	virtual bool OnOpenController() = 0;
...
#elif defined(HY_USE_SDL2)
	virtual bool OnOpenController() override;
