...
public:
	...
	virtual std::pair<HyBufferHandle, HyTextureHandle> AddTextureBufferObject(HyImageInfo imageInfo, HyTextureInf textureInfo, unsigned char *pData, uint32 uiDataSize) = 0;
