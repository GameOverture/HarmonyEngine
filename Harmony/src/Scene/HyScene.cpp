...
{
	
	// BUFFER HEADER (contains offsets from here)-| Num 3d Cams (4bytes)-|-Cam3d-|-Cam3d-|...|-Num 2d Cams (4bytes)-|-Cam2d-|-Cam2d-|...|-Num 3d Insts (4bytes)-|-Inst3d-|-Inst3d-|-Inst3d...-|-Num 2d Insts (4bytes)-|-Inst2d-|-Inst2d-|-Inst2d...-|-<possible blank/empty data since we skip non-enabled instances>-|-Uniforms Data-|-Vertex Data...|-Uniforms Data-|-VertexData...
	
	...
	*(reinterpret_cast<int32 *>(pWriteNum3dInstsHere)) = iCount;
	...
	for(size_t i = 0; i < uiTotalNumInsts; ++i)
	{
		...
		if(pCurRenderState2d == NULL || m_vLoadedInst2d[i]->GetRenderState() != *pCurRenderState2d)
		{
			...
			// WriteUniformsBufferData() is responsible for incrementing the draw pointer to after what's written
			pCurRenderState2d->WriteUniformsBufferData(pCurVertexWritePos);	// Also clears Uniforms' dirty flag
