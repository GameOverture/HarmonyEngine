...
InputDevice::InputDevice(InputManager& manager, DeviceId device, unsigned index) :
	...
	bufferedButtonInputs_(manager.GetAllocator()) // Added by -JJK
...
InputDevice::Update(InputDeltaState* delta)
{
	*previousState_ = *state_;
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Apply button downs to previousState_ if both "down" and "up" messages were handled before a single Update() -JJK
