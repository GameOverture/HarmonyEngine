...
// Will determine platform here and include proper config.h file
// I don't want to use CMAKE :(

#if defined(_WIN64) || defined(__LP64__) || defined(__LP64) || (defined(_WIN32) || defined(__WIN32__) || defined(__WINDOWS__))
