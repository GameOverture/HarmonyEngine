...
extern void (* Gamepad_buttonDownCallback)(struct Gamepad_device * device, unsigned int buttonID, void * context);
extern void (* Gamepad_buttonUpCallback)(struct Gamepad_device * device, unsigned int buttonID, void * context);
extern void (* Gamepad_axisMoveCallback)(struct Gamepad_device * device, unsigned int axisID, float value, float lastValue, void * context);
