...
public:
	...
	inline void Set(float fX, float fY, float fZ, float fW)		{ m_vAnimFloats[0] = fX; 
	m_vAnimFloats[1] = fY; 
	m_vAnimFloats[2] = fZ; 
	m_vAnimFloats[3] = fW; }
	...
	inline void Offset(float fX, float fY, float fZ, float fW)	{ m_vAnimFloats[0] += fX; m_vAnimFloats[1] += fY; m_vAnimFloats[2] += fZ; m_vAnimFloats[3] += fW; }
