...
DlgNewPackage::DlgNewPackage(Project &projectRef, QWidget *parent) :
	QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint),
	m_ProjectRef(projectRef),
	ui(new Ui::DlgNewPackage)
{
	ui->setupUi(this);
	...
	connect(ui->wgtBuildDir, &WgtMakeRelDir::OnDirty, this, &DlgNewPackage::ErrorCheck);
...
DlgNewPackage::~DlgNewPackage()
{
	delete ui;
}

QString DlgNewPackage::GetProc() const
{
...
#else
		HyGuiLog("DlgNewPackage::GetProc() not implemented on this platform", LOGTYPE_Error);
#endif
	}
...
QStringList DlgNewPackage::GetProcOptions() const
{
	if(ui->radDesktop->isChecked())
	{
...
void DlgNewPackage::on_buttonBox_accepted()
{
	
}

void DlgNewPackage::on_radDesktop_clicked()
{
	ui->stackedWidget->setCurrentIndex(PLAT_Desktop);
	ui->wgtBuildDir->Setup("Build", "desktop", m_ProjectRef.GetDirPath(), "builds");
	ErrorCheck();
...
void DlgNewPackage::on_radBrowser_clicked()
{
...
void DlgNewPackage::on_radCMake_clicked()
{
...
void DlgNewPackage::on_radCMakeGui_clicked()
{
...
void DlgNewPackage::on_cmbCMake_currentIndexChanged(int iIndex)
{
...
void DlgNewPackage::on_btnCMakeHelp_clicked()
{
	QMessageBox::information(this, "CMake Help", m_sCMakeHelp, QMessageBox::Ok);
}

void DlgNewPackage::on_txtEmscriptenSdk_textChanged(const QString &arg1)
{
	ErrorCheck();
}

void DlgNewPackage::on_btnEmscriptenSdkBrowse_clicked()
{
