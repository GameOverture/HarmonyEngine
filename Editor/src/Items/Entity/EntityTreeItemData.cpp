...
void EntityTreeItemData::InitalizePropertyModel()
{
	...
	case ITEM_PrimLayer: {
		...
		m_pEditModel = new EditModeModel(false, HyGlobal::GetEditorColor(EDITORCOLOR_EditMode));
	...
	case ITEM_ShapeFixture: {
		m_pEditModel = new EditModeModel(false, HyGlobal::GetEditorColor(EDITORCOLOR_Fixtures));
	...
	case ITEM_ChainFixture: {
		m_pEditModel = new EditModeModel(true, HyGlobal::GetEditorColor(EDITORCOLOR_Fixtures));
