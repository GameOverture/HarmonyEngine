...
/*static*/ void HyGlobal::Initialize()
{
	...
	sm_sItemNames[ITEM_AtlasTileSet] = "TileSet";
	...
	sm_sItemNamesPlural[ITEM_AtlasTileSet] = "TileSets";
	...
	sm_EditorColors[EDITORCOLOR_Marquee] = HyColor::Blue;
	sm_EditorColors[EDITORCOLOR_TransformBoundingVolume] = HyColor::Orange;
	...
	sm_EditorColors[EDITORCOLOR_CenterGrabPointOutline] = HyColor::Black;
	sm_EditorColors[EDITORCOLOR_CenterGrabPointFill] = HyColor::Yellow;
	...
	sm_pFileNameValidator = new QRegularExpressionValidator(QRegularExpression("[A-Za-z0-9\\.\\(\\)|_\\-]*"));				// Alphanumeric and valid filename symbols. Allows periods '.'
...
#define CROP_THRESHOLD 1
/*static*/ QRect HyGlobal::AlphaCropImage(const QImage &img)
{
	int j, w, h, x, y;
	bool t;
