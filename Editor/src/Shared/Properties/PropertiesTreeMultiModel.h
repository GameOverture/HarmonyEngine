...
public:
	explicit PropertiesTreeMultiModel(ProjectItemData *pProjItemData, int iStateIndex, QVariant subState, const QList<PropertiesTreeModel *> &multiModelListRef, QObject *pParent = nullptr);
