...
enum EditorColor
{
	...
	EDITORCOLOR_CenterGrabPointOutline,
	EDITORCOLOR_CenterGrabPointFill,
...
#define ENTITYCUSTOMBASECLASS_STRING_ID "Custom Entity"
const QString ENTITYBASECLASSTYPE_STRINGS[NUM_ENTBASECLASSTYPES] = { "HyEntity2d", "HyActor2d", "HyGui", ENTITYCUSTOMBASECLASS_STRING_ID };
...
public:
	...
	static HyColor ConvertQColor(QColor color);
