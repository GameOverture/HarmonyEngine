...
HyText2dData::HyText2dData(const std::string &sPath, const jsonxx::Object &itemDataObjRef, HyAssets &assetsRef) :
	IHyNodeData(sPath),
	...
	m_uiNumStates(0)
{
	...
	if(sPath == HY_GUI_DATAOVERRIDE)
		...
		m_pAtlas = assetsRef.GetAtlas(static_cast<uint32>(itemDataObjRef.get<jsonxx::Number>("checksum")), rSubAtlasUVRect);
#else
	m_pAtlas = assetsRef.GetAtlas(static_cast<uint32>(itemDataObjRef.get<jsonxx::Number>("checksum")), rSubAtlasUVRect);
#endif
	...
	else
	{
		...
		uiFullAtlasWidth = static_cast<uint32>(itemDataObjRef.get<jsonxx::Number>("subAtlasWidth"));
		uiFullAtlasHeight = static_cast<uint32>(itemDataObjRef.get<jsonxx::Number>("subAtlasHeight"));
	}
	...
	jsonxx::Array fontArray = itemDataObjRef.get<jsonxx::Array>("fontArray");
	...
	jsonxx::Array stateArray = itemDataObjRef.get<jsonxx::Array>("stateArray");
